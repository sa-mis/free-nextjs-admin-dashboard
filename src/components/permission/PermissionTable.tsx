            ...
            <div className="mt-3">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-900">{selectedPermission.role_count || 0}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-700">Created:</label>
                  <p className="text-sm text-gray-900">{formatDate(selectedPermission.created_at)}</p>
                </div>
              </div>
              <div className="mt-6 flex justify-end">
                <Button onClick={() => setSelectedPermission(null)}>Close</Button>
              </div>
            </div>
          </div>
        </div>
