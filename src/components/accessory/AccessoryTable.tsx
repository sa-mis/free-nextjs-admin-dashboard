                ...
                <tr key={row.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <div className="flex space-x-2">
                      <Button variant="outline" size="sm" onClick={() => setSelectedAccessory(row)} className="text-blue-600 hover:text-blue-900"><EyeIcon className="w-4 h-4" /></Button>
                      <Button variant="outline" size="sm" onClick={() => onEdit(row)} className="text-green-600 hover:text-green-900"><PencilIcon className="w-4 h-4" /></Button>
                      <Button variant="outline" size="sm" onClick={() => handleDelete(row.id)} className="text-red-600 hover:text-red-900"><TrashIcon className="w-4 h-4" /></Button>
                      <Button variant="outline" size="sm" onClick={() => onAssign(row)} className="text-yellow-600 hover:text-yellow-900">Assign</Button>
                      <Button variant="outline" size="sm" onClick={() => onStockMovement(row)} className="text-indigo-600 hover:text-indigo-900">Stock</Button>
                    </div>
                  </td>
                </tr>
              ))}
